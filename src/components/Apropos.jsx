...
return (
    ...
    <div className='container-fluid apro mt-5'>
        <div className='row col-lg-12  '>
            <img src={imgLogo} class="imgApropos mx-auto mt-2 "/>
            <h1 className='text-center '>Beni Ourtilane</h1>
 
            <div className='col-lg-6  text-center text2 mt-4 '>
                <p>
                        SOYEZ FIERS DE VOS RACINES IMAZIGHEN !
                        Être berbère, c'est être un homme libre.

                        Que vous soyez Kabyles, Chleuhs, Chenouis, Mozabites, Chaouis, Guanches, Touaregs ou Rifains, nous sommes avant tout unifiés par des traditions communes d’hospitalité, de solidarité et de liberté.

                        Avec les années, le drapeau berbère est devenu le symbole d’un peuple en lutte pour sa survie.

                        La couleur rouge du sigle symbolise la vie.

                        C'est le sang qui unit tous les peuples berbères de Libye, de Tunisie, d’Algérie, du Maroc et des îles Canaries.

                        Ce sont des valeurs universelles qui nous unissent bien au-delà des frontières.    
                    ...
                    <div className='row col-lg-6 mt-5 nadir  '>
                        <div className='mx-auto  '>
                        <h1 className='mx-4 mt-2 text-center '>Roujoinez nous</h1>
                        <ul className='maliste  mr-2 mx-auto d-flex  mb-4  '>
                            <li className=' mx-2'>
                                <a href="#">
